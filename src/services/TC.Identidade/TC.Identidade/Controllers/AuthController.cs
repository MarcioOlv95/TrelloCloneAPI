...
using TC.Identidade.Models;

namespace TC.Identidade.Controllers
{
    [ApiController]
    [Route("api/identidade")]
    public class AuthController : MainController
    {
        private readonly SignInManager<IdentityUser> _signInManager; //gerenciar questões de login
        private readonly UserManager<IdentityUser> _userManager; //gerenciar administra esse user
